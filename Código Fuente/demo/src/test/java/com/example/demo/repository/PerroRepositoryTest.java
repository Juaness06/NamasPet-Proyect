...
public class PerroRepositoryTest {
    ...
    @BeforeEach
    void init() {
        perroRepository.save(new Perro("imagen1.jpg", "Hermann", "Chihuahua", 5, true, 20.0, 1));
        perroRepository.save(new Perro("imagen2.jpg", "Chamo", "Pug", 3, false, 10.0, 2));
    }

    @Test
    public void PerroRepository_save_Perro() {

        Perro perro = new Perro("imagen3.jpg", "Nico", "German Shepherd", 4, true, 30.0, 3);
