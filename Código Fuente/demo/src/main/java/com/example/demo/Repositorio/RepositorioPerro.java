...
public class RepositorioPerro {
    ...
    public RepositorioPerro() {
        ...
        data.put(5, new Perro("https://media.istockphoto.com/id/487853665/es/foto/bulldog-ingl%C3%A9s-contra-fondo-gris-oscuro-retrato-de-estudio.jpg?s=1024x1024&w=is&k=20&c=2RvQwTg1NvqQ0N_6PmHXh0ndZQAvggtQp6Yq24KqO-NU=", "Max", 005, "American-Bulldog", 4, true, 15.2, 5));
