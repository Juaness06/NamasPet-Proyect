...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
            ...
            String[] apellidos = {"González", "Rodríguez", "Martínez", "Sánchez", "Pérez", "López", "García", "Díaz", "Vásquez", "Jiménez","Álvarez", "Benítez", "Camacho", "Domínguez", "Espinoza",
            ...
            for (int i = 1; i <= 50; i++) {
                ...
                String email = nombresClientes[i % nombresClientes.length] + apellidos[i % apellidos.length] + i + "@ejemplo.com";
            ...
            String[] razas = {"Labrador", "Bulldog", "Beagle", "Poodle", "Boxer", "Dálmata", "Pastor Alemán", "Golden Retriever", "Husky Siberiano", "Chihuahua"};
